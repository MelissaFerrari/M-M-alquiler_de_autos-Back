...
public class ReservaController {
	...
	public ResponseEntity<?> actualizarReserva(@PathVariable Integer id, @RequestBody Map<String, Object> cambios) {
	    ...
	    cambios.forEach((campo, valor) -> {
	        switch (campo) {
	            ...
	            case "dominio_auto":
	                Auto auto = new Auto();
	                auto.setDominio((String) valor);
	                reserva.setAuto(auto);
	                break;
	            case "fecha_inicio":
	                reserva.setFechaInicio(LocalDate.parse((String) valor));
	                break;
	            case "fecha_fin":
	                reserva.setFechaFin(LocalDate.parse((String) valor));
	                break;
	        }
	    });
